...
# Uso exclusivo para ambientes Windows com VM e NAT (sem WSL)
...
# Caminho fixo para o VBoxManage.exe
...
# Utilizado por GNS3 para comunicação entre nós, dynamips, uBridge, etc.
